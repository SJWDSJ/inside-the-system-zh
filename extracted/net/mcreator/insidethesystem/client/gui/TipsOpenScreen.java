...
public class TipsOpenScreen
extends AbstractContainerScreen<TipsOpenMenu> {
    ...
    private static final ResourceLocation texture = ResourceLocation.parse((String)"inside_the_system:textures/screens/tips_open.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
        ...
        guiGraphics.blit(ResourceLocation.parse((String)"inside_the_system:textures/screens/0tips.png"), this.leftPos + -7, this.topPos + -29, 0.0f, 0.0f, 177, 219, 177, 219);
    ...
    public void init() {
        ...
        this.imagebutton_exit = new ImageButton(this, this.leftPos + 130, this.topPos + 172, 15, 8, new WidgetSprites(ResourceLocation.parse((String)"inside_the_system:textures/screens/exit.png"), ResourceLocation.parse((String)"inside_the_system:textures/screens/exit2.png")), e -> {
            PacketDistributor.sendToServer((CustomPacketPayload)new TipsOpenButtonMessage(0, this.x, this.y, this.z), (CustomPacketPayload[])new CustomPacketPayload[0]);
