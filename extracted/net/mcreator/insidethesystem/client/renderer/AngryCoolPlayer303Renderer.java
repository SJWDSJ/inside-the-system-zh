...
public class AngryCoolPlayer303Renderer
extends HumanoidMobRenderer<AngryCoolPlayer303Entity, HumanoidModel<AngryCoolPlayer303Entity>> {
    public AngryCoolPlayer303Renderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(AngryCoolPlayer303Entity entity) {
        return ResourceLocation.parse((String)"inside_the_system:textures/entities/angry.png");
    }
}
