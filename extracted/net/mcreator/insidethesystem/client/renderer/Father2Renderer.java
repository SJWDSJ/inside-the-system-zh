...
public class Father2Renderer
extends HumanoidMobRenderer<Father2Entity, HumanoidModel<Father2Entity>> {
    public Father2Renderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(Father2Entity entity) {
