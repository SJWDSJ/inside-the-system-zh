...
public class AngryBuilderRenderer
extends HumanoidMobRenderer<AngryBuilderEntity, HumanoidModel<AngryBuilderEntity>> {
    public AngryBuilderRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(AngryBuilderEntity entity) {
