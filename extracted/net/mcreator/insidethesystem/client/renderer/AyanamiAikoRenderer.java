...
public class AyanamiAikoRenderer
extends HumanoidMobRenderer<AyanamiAikoEntity, HumanoidModel<AyanamiAikoEntity>> {
    public AyanamiAikoRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(AyanamiAikoEntity entity) {
        return ResourceLocation.parse((String)"inside_the_system:textures/entities/aiko.png");
    }
}
