...
public class LostRenderer
extends HumanoidMobRenderer<LostEntity, HumanoidModel<LostEntity>> {
    ...
    public ResourceLocation getTextureLocation(LostEntity entity) {
        return ResourceLocation.parse((String)"inside_the_system:textures/entities/lost.png");
    }
}
