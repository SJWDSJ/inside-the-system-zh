...
import net.mcreator.insidethesystem.procedures.SafeIpProcedure;
...
@EventBusSubscriber
public class SafeIpCommandCommand {
    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent event) {
        event.getDispatcher().register((LiteralArgumentBuilder)Commands.literal((String)"safeip").executes(arguments -> {
            ...
            SafeIpProcedure.execute((LevelAccessor)world);
            return 0;
        }));
    }
}
