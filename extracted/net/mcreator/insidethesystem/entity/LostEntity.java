 ...
 *  net.mcreator.insidethesystem.procedures.LostDialogueProcedure
...
import net.mcreator.insidethesystem.procedures.LostDialogueProcedure;
import net.mcreator.insidethesystem.procedures.LostUpdateProcedure;
...
extends PathfinderMob {
    public LostEntity(EntityType<LostEntity> type, Level world) {
        super(type, world);
        this.xpReward = 0;
        this.setNoAi(false);
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        double y = this.getY();
        double z = this.getZ();
        LostEntity entity = this;
        Level world = this.level();
        LostDialogueProcedure.execute((LevelAccessor)world);
        return retval;
    }

    public void baseTick() {
        super.baseTick();
        LostUpdateProcedure.execute((LevelAccessor)this.level(), (Entity)this);
    }
