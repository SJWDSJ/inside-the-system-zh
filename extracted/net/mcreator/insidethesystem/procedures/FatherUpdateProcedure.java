...
public class FatherUpdateProcedure {
    public static void execute(LevelAccessor world, Entity entity) {
        ...
        if (!InsideTheSystemModVariables.MapVariables.get((LevelAccessor)world).FatherKill) {
            if (entity instanceof LivingEntity) {
                LivingEntity _entity = (LivingEntity)entity;
                _entity.setHealth(5.0f);
            }
            InsideTheSystemModVariables.MapVariables.get((LevelAccessor)world).FatherKill = true;
