...
import net.mcreator.insidethesystem.procedures.WarningPriZakrytiiIntierfieisaProcedure;
...
implements Supplier<Map<Integer, Slot>> {
    ...
    public WarningMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)InsideTheSystemModMenus.WARNING.get(), id);
    ...
    public void removed(Player playerIn) {
        ...
        WarningPriZakrytiiIntierfieisaProcedure.execute((LevelAccessor)this.world, this.x, this.y, this.z);
    }
