...
public class PasswordWriteMenu
...
implements Supplier<Map<Integer, Slot>> {
    ...
    public PasswordWriteMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)InsideTheSystemModMenus.PASSWORD_WRITE.get(), id);
