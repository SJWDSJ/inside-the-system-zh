...
implements Supplier<Map<Integer, Slot>> {
    ...
    public TipsOpen1Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)InsideTheSystemModMenus.TIPS_OPEN_1.get(), id);
