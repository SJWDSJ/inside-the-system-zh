...
implements Supplier<Map<Integer, Slot>> {
    ...
    public TipsOpen2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)InsideTheSystemModMenus.TIPS_OPEN_2.get(), id);
