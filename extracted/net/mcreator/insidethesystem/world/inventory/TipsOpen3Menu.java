...
implements Supplier<Map<Integer, Slot>> {
    ...
    public TipsOpen3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super((MenuType)InsideTheSystemModMenus.TIPS_OPEN_3.get(), id);
